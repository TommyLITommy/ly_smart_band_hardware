...
#define SPI_SCK_PIN           G_SENSOR_SCLK_PIN_NUMBER 
#define SPI_MISO_PIN          G_SENSOR_MISO_PIN_NUMBER 
#define SPI_MOSI_PIN          G_SENSOR_MOSI_PIN_NUMBER
#define SPI_SS_PIN            G_SENSOR_CS_PIN_NUMBER
